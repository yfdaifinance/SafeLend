...
/**
  * @title Safelend's DAIInterestRateModel Contract (version 2)
  * @author Safelend (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Safelend Protocol whitepaper.
